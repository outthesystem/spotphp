        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'manage-albums' || $page == 'manage-categories' || $page == 'add-categories' || $page == 'edit-categories' || $page == 'manage-songs' || $page == 'add-songs' || $page == 'edit-songs' || $page == 'manage-song-price' || $page == 'add-song-price' || $page == 'edit-song-price' || $page == 'payment-requests') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
            ...
            <div class="legal">
                ...
                <div class="version">
                    <b>Version: </b> <?php echo $music->config->script_version ?>
                </div>
            </div>
            <!-- #Footer -->
        </aside>
